...
<svg width="512" height="512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="1" y2="1">
      ...
      <stop offset="100%" stop-color="#a445ff"/>
    </linearGradient>
  ...
  <path d="M256 118c-6 0-11 4-13 10-8 24-30 40-30 76 0 26 21 47 47 47s47-21 47-47c0-14-6-24-13-33 12 6 30 24 30 54 0 39-32 71-71 71s-71-32-71-71c0-56 41-84 61-96 6-4 9-8 13-11z" fill="url(#ring)"/>
