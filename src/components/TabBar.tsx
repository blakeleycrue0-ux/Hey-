...
export const TabBar = ({ tab, onChange, onAdd }: Props) => (
  <div className="fixed inset-x-0 bottom-0 z-30 mx-auto max-w-md pb-[env(safe-area-inset-bottom)]">
    <div className="mx-4 mb-4 flex items-center justify-between rounded-2xl border border-black/5 dark:border-white/[0.08] bg-white/90 dark:bg-zinc-900/90 px-8 py-3 shadow-lg backdrop-blur-md">
      <button
